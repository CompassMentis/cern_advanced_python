...
Profiling shows that distance_to_squared (still) takes up a lot of time
The math module contains a dist() function which we can use instead. This may be faster

Duration at start 2.6707638090010732
Duration at end 2.4633738940010517
"""
import timeit
import math
